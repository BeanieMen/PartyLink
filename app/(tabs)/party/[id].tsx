...
const PartyDetailsScreen: React.FC = () => {
  ...
  const handleAttend = async () => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/party/${party.party_id}/attend?userId=${userId}`)
      ...
      >
        ...
        {screenWidth < 768 && (
          <View style={styles.ticketCard}>
            <View style={styles.ticketHeader}>
              ...
              <View style={[
                styles.ticketBadge,
                { backgroundColor: party.tickets_left > 0 ? DboardColors.greenBg : DboardColors.redBg }
              ]}>
                <Text style={[
            ...
            <TouchableOpacity
              style={[
                styles.attendButton,
                {
                  backgroundColor: party.tickets_left > 0
                    ? DboardColors.pink500
                    : "#4A5568"
                }
              ]}
        ...
        <View style={styles.descriptionCard}>
          ...
          <Text style={styles.descriptionText}>
            {party.description || "Join us for an unforgettable night of music, dancing, and fun! This exclusive party brings together the best DJs, amazing drinks, and a crowd ready to celebrate. Don't miss out on the party of the year!"}
          </Text>
        </View>
